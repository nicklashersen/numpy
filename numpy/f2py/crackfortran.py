...
def _analyze_data_case(m, case, line):
    """
    Perform data line analysis.
    """

    global groupcounter, groupcache, previous_context
...
def _analyze_implicit_case(m, case, line):
    """
    Perform implicit line analysis.
    """
...
def _analyze_common_case(m, case, line):
    """
    Perform implicit line analysis.
    """
...
def _analyze_parameter_case(m, case, line):
    """
    Perform parameter line analysis.
    """

    global groupcache, groupcounter, previous_context
...
def analyzeline(m, case, line):
    ...
    if case in ['begin', 'call', 'callfun']:
        ...
        _analyze_parameter_case(m, case, line)
    elif case == 'implicit':
        _analyze_implicit_case(m, case, line)
    elif case == 'data':
        _analyze_data_case(m, case, line)
    elif case == 'common':
        _analyze_common_case(m, case, line)
    elif case == 'use':
        m1 = re.match(
